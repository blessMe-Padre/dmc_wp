<?php
/*
Template Name: Страница мероприятий - шаблон 
*/
get_header();
?>
<main>
        ...
        <div class="container pt-20">
            ...
            <ul class="flex pt-10 min-w-[100%] flex-wrap items-center justify-center">
                <li class="relative md:pr-6">
                    <img class="rounded-lg w-[440px]" src="./src/img/event/image 26.png" />
                    <p class="pt-2 text-base lg:text-2xl font-bold ">DMC K-POP CAFE празднует День <br> Рождение Чимина
                    </p>
                    <div class="flex items-center justify-between gap-3">
                        ...
                        <a href="#"
                            ...
                            <img class="" src="./src/img/icons/arrow-corner.svg" alt="вправо" />
                        </a>
                    </div>
                </li>
                <li class="relative md:pr-6">
